...
<html>
<head>
	<title>Clim100 Sample BDM</title>
...
<ul>
<li>Refer to the linux tuning: <a href="http://fasterdata.es.net/">http://fasterdata.es.net/</a></li>
</ul>
...
<ul>
	...
	<li><a href="https://sdm.lbl.gov/BDM/BDMSamplePlots.html">Sample BDM transfer plots from LLNL to NERSC, Aug 2010</a></li>
</ul>
...
<ul>
	...
	<li>To download the data, please download the database file, store in your $BDM_HOME/bin location, ant
use the following commands as it is, including the requesttoken.</li>
</ul>
<table>
<tr>
	<th>Request Id</th>
...
<ul>
	<li>IPCC data (/export/ftp/pub/dean/ipcc) from LLNL is broken into following requests and stored in the database file.</li>
	<li>To download the data, please <a href="https://sdm.lbl.gov/bdm/bdmDB-llnl.h2.db">download the database file</a>, store in your $BDM_HOME/bin location, and use the following commands as it is, including the requesttoken.</li>
</ul>
<table>
<tr>
	<th>Request Id</th>
