...
<h1>SRM-PERMISSION-SET: BeStMan SRM-Client Tools User's Guide</h1>
<ul>
<li>srm-permission-set requests to set permissions on SURLs.</li>
</ul>
<h1>Usage</h1>
<ul>
<li>srm-permission-set &lt;source_url&gt; [command line options]</li>
<li>srm-permission-set -f &lt;input_file&gt; [command line options]</li>
</ul>
<h1>Options</h1>
<ul>
...
<ul>
<li>srm-permission-set -s srm://host:port/wsept?SFN=/source_filepath -permissiontype &lt;type&gt; -userpermissions &lt;user:mode&gt; -grouppermissions &lt;group:mode&gt; -otherpermission &lt;mode&gt;</li>
<ul>
<li>This command requests to set the permission information on the SURL. <a href="/srmclients/samples/srm-permission-set-11.txt">Click here for the sample output.</a></li>
<ul>
<li>srm-permission-set srm://bestman.lbl.gov:8443/srm/v2/server?SFN=/srmcache/guest/test.data -permissiontype add -userpermissions &ldquo;user1:rw,user2:r,user3:r&rdquo;</li>
<li>srm-permission-set srm://bestman.lbl.gov:8443/srm/v2/server\?SFN=/srmcache/guest/test.data -permissiontype add -grouppermissions &ldquo;group1:rw,group2:r&rdquo;</li>
<li>srm-permission-set srm://bestman.lbl.gov:8443/srm/v2/server\?SFN=/srmcache/guest/test.data -permissiontype add -otherpermission r</li>
<li>srm-permission-set srm://bestman.lbl.gov:8443/srm/v2/server\?SFN=/srmcache/guest/test.data -permissiontype add -userpermissions &ldquo;user1:rw,user2:r,user3:r&rdquo; -grouppermissions &ldquo;group1:rw,group2:r&rdquo; -otherpermission r</li>
<li>srm-permission-set srm://bestman.lbl.gov:8443/srm/v2/server\?SFN=/srmcache/guest/test.data -permissiontype change -userpermissions &ldquo;user1:r&rdquo; -grouppermissions &ldquo;group1:r&rdquo; -otherpermission none</li>
</ul>
</ul>
</ul>
...
<h1>See Also</h1>
<ul>
<li><a href="SRMUtil">srm-util</a>, <a href="SRMPermissionCheck">srm-permission-check</a>, <a href="SRMPermissionGet">srm-permission-get</a></li>
