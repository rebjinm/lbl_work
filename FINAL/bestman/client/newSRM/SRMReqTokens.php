...
<h1>SRM-REQ-TOKENS: BeStMan SRM-Client Tools User's Guide</h1>
<ul>
<li>srm-req-tokens retrieves request tokens for the client, using specified request description. This is to accommodate lost request tokens. This can also be used for getting all request tokens back that belong to the client.</li>
</ul>
<h1>Usage</h1>
<ul>
<li>srm-req-tokens &lt;user_description&gt; -serviceurl &lt;service_url&gt; [command line options]</li>
</ul>
<h1>Options</h1>
<ul>
...
<ul>
<li>srm-req-tokens &lt;request_description&gt; -serviceurl srm://host:port/wsept</li>
<ul>
<li>This command requests to retrieve the request tokens that belong to the client. [[/srmclients/samples/srm-req-tokens-11.txt][Click here for the sample output.]]</li>
<ul>
<li>srm-req-tokens &ldquo;my test requests&rdquo; -serviceurl srm://bestman.lbl.gov:8443/srm/v2/server</li>
<li>srm-req-tokens -userdesc &ldquo;my tes request&rdquo; -serviceurl srm://bestman.lbl.gov:8443/srm/v2/server</li>
</ul>
</ul>
</ul>
