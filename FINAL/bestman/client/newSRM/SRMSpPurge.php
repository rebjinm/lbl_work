...
<h1>SRM-SP-PURGE: BeStMan SRM-Client Tools User's Guide</h1>
<ul>
<li>srm-sp-purge requests to remove files from a space that is specified by the space token.</li>
</ul>
<h1>Usage</h1>
<ul>
<li>srm-sp-purge &lt;service_url&gt; -spacetoken &lt;space_token&gt; [command line options]</li>
<li>srm-sp-purge &lt;service_url&gt; -spacetoken &lt;space_token&gt; -s &lt;source_url&gt; [command line options]</li>
<li>srm-sp-purge &lt;service_url&gt; -spacetoken &lt;space_token&gt; -f &lt;intput_file&gt;  [command line options]</li>
</ul>
<h1>Options</h1>
<ul>
...
<h1>Notes</h1>
<ul>
<li>srm client makes no proxy delegation by default, and automatically handles proxy delegation based on the source urls. A user can override the automatic handling by providing an option ì-delegationî (or ì-delegation trueî) to force the delegation, and ì-delegation falseî to force no delegation. ì-debugî option would show how the delegation is done on the output.</li>
</ul>
<p></p>
...
<h2>Purge a space</h2>
<ul>
<li>srm-sp-purge  srm://host:port/wsept  -spacetoken &lt;space_token&gt; -s srm://host:port/wsept?SFN=/source_filepath</li>
<ul>
<li>This command requests to purge a file from the space that is specified with the space token. [[/srmclients/samples/srm-sp-purge-11.txt][Click here for the sample output.]]</li>
<ul>
<li>srm-sp-purge  srm://bestman.lbl.gov:8443/srm/v2/server   -spacetoken SPACE_TOKEN_V12345  -s srm://bestman.lbl.gov:8443/srm/v2/server?SFN=/srmcache/guest/test.file</li>
</ul>
</ul>
</ul>
<p></p>
