...
<div id="page">
<h1>SRM-SP-CHANGE: BeStMan SRM-Client Tools User's Guide</h1>
<ul>
<li>srm-sp-change requests to change the space property of files to another space property by specifying target space tokens.  All files specified by SURLs will have a new space token. SURLs will not be changed. New space token may be acquired from srm-sp-reserve. There is no default behavior when target space token is not provided, and in such case, the request will be failed.</li>
</ul>
<h1>Usage</h1>
<ul>
<li>srm-sp-change &lt;service_url&gt; -spacetoken &lt;space_token&gt; -s &lt;source_url&gt; [command line options]</li>
<li>srm-sp-change &lt;service_url&gt; -spacetoken &lt;space_token&gt; -f &lt;input_file&gt;  [command line options]</li>
</ul>
<h1>Options</h1>
<ul>
...
<ul>
<li>srm-sp-change  srm://host:port/wsept -spacetoken &lt;space_token&gt; -s srm://host:port/wsept?SFN=/source_filepath</li>
<ul>
<li>This command requests to change space for a file to space that is specified with the space token. [[/srmclients/samples/srm-sp-change-11.txt][Click here for the sample output.]]</li>
<ul>
<li>srm-sp-change  srm://bestman.lbl.gov:8443/srm/v2/server   -spacetoken SPACE_TOKEN_V12345  -s srm://bestman.lbl.gov:8443/srm/v2/server?SFN=/srmcache/guest/test.file</li>
</ul>
</ul>
</ul>
<p></p>
