...
<div id="page">
<h1>SRM-REQ-ABORTFILES: BeStMan SRM-Client Tools User's Guide</h1>
<ul>
<li>srm-req-abortfiles requests to abort files in a request.</li>
</ul>
<h1>Usage</h1>
<ul>
<li>srm-req-abortfiles &lt;source_url&gt; -requesttoken &lt;token&gt; [command line options]</li>
<li>srm-req-abortfiles -f &lt;input_file&gt; -serviceurl &lt;service&gt; [command line options]</li>
</ul>
<h1>Options</h1>
<ul>
...
<ul>
<li>srm-req-abortfiles srm://host:port/wsept?SFN=/my_file_path -requesttoken &lt;request_token&gt;</li>
<ul>
<li>This command requests to abort a file in the request that is specified with the request token. [[/srmclients/samples/srm-req-abortfiles-11.txt][Click here for the sample output.]]</li>
<ul>
<li>srm-req-abortfiles srm://bestman.lbl.gov:8443/srm/v2/server?SFN=/srmcache/guest/test.file -requesttoken TOKEN_GET_12345</li>
<li>srm-req-abortfiles -s srm://bestman.lbl.gov:8443/srm/v2/server?SFN=/srmcache/guest/test.file -requesttoken TOKEN_GET_12345</li>
</ul>
</ul>
</ul>
