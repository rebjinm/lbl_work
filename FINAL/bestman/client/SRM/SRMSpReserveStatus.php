...
<ul>
<li>This command requests to check the status of the space reservation request. <a href="/srmclients/samples/srm-sp-reserve-status-11.txt">Click here for the sample output.</a></li>
<ul>
