...
<div id="page">
<h1>SRM-SP-RELEASE: BeStMan SRM-Client Tools User's Guide</h1>
<ul>
<li>srm-sp-release requests to release a reserved space.</li>
</ul>
<h1>Usage</h1>
<ul>
<li>srm-sp-release &lt;service_url&gt; -spacetoken &lt;space_token&gt; [command line options]</li>
</ul>
<h1>Options</h1>
<ul>
...
<tr>
<td>-forcerelease</td>
<td><ul><li>Requests to release files forcefully in the space before releasing the space</li><li>Default=false </li></ul></td>
</tr>
<tr>
<td>-help</td>
...
<ul>
<li>srm-sp-release srm://host:port/wsept -spacetoken &lt;space_token&gt;</li>
<ul>
<li>This command requests to release a previously reserved space and all files in the space that is specified with the space token, regardless of their file statuses. [[/srmclients/samples/srm-sp-release-11.txt][Click here for the sample output.]]</li>
<ul>
<li>srm-sp-release srm://bestman.lbl.gov:8443/srm/v2/server -spacetoken SPACE_TOKEN_V12345</li>
</ul>
</ul>
<li>srm-sp-release srm://host:port/wsept -spacetoken &lt;space_token&gt; -forcerelease</li>
<ul>
<li>This command requests to release a previously reserved space in the SRM that is specified with the space token, and their file statuses. [[/srmclients/samples/srm-sp-release-21.txt][Click here for the sample output.]]</li>
<ul>
<li>srm-sp-release srm://bestman.lbl.gov:8443/srm/v2/server -spacetoken SPACE_TOKEN_V12345 -forcerelease</li>
</ul>
</ul>
</ul>
